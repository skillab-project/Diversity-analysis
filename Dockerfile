...
# Install R packages
#RUN R -e "install.packages(c('plumber', 'httr', 'dplyr', 'readxl', 'ggplot2', 'plotly', 'tidyverse', 'archetypes', 'Anthropometry', 'SpadeR', 'fmsb', 'ggradar', 'jsonlite', 'formatR', 'shiny', 'DT', 'shinyBS'), repos='https://cran.rstudio.com')"
