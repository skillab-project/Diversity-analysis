...
job_skill_matrix_construction<-function(unique_skills,occupations_jobs,arr,skill_matrix){
  jobs_ids<-c()
  occupations_id4<-c()
  ...
  df$`Occupation_Label4`<-New_occupation_table$Label4[
    match(df$Occupation_ID4, New_occupation_table$id4)
  ]
  df$`Occupation_ID3`<-New_occupation_table$id3[
    match(df$Occupation_ID4, New_occupation_table$id4)]
  df$`Occupation_Label3`<-New_occupation_table$Label3[
    match(df$Occupation_ID4, New_occupation_table$id4)]
...
jobs_skill_analysis<-function(groups_all,token,URL_base){
  for(group_i in groups_all){
    code<-New_occupation_table$Codes[match(group_i,New_occupation_table$Group)]
    print(code)
    
    occupations_table<-New_occupation_table[New_occupation_table$Group==group_i,]
    ...
    skill_matrix_job<-job_skill_matrix_construction(un_skills,occupations_jobs,arr,skill_matrix)
    
    occ_table<-New_occupation_table[New_occupation_table$Group==group_i,]
